...
known_face_names = ["Chavalit", "nongpee"]
...
while True:
    ...
    if ret:
        ...
        for (top,right,bottom, left), name, percent in zip(face_locations, face_names, face_percent):
            ...
            cv2.putText(frame, name, (left+10, top-10), font, 0.6, (255,255,255), 1)
